...
export class CourseReview extends CourseRelatedPost {
  ...
  constructor(subject: string, content: string, owner: UiUser, uiCourse: UiCourse, rank: number, id?: string, timestamp?: Date) {
    super(subject, content, owner, uiCourse, id, timestamp);
    this.rank = rank;
  }
  ...
  static deserialize(dbReview: any): CourseReview {
    ...
    return new CourseReview(dbReview.subject, dbReview.content, owner, uiCourse, dbReview.rank, dbReview._id, dbReview.timestamp);
  }
}
